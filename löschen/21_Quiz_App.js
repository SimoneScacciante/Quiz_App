...
// <<<<<<<====== Das hier unten entspricht exact selbe wie oben!!! =====>>>>>>>>
...
function restartGame() {
    ...
    document.getElementById('progress-bar').innerHTML = `${0}%`;    // Progress Bar auf Reset gesetzt (nun von 100 auf 0 erscheint)
    document.getElementById('progress-bar').style.width = ` ${0}%`; // Ganz gefüllter blauer Balken verschwindet
